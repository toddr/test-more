...
Each test can be given a little description as the second
argument to C<ok()>.
...
=head2 Informative descriptions
...
itself we're trying out to the description.  So you get results like:
...
debugging information into the test descriptions.
